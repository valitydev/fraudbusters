...
import dev.vality.fraudbusters.dgraph.service.data.DgraphPaymentCountQueryBuilderServiceTestData;
...
public class DgraphPaymentCountQueryBuilderServiceTest extends AbstractDgraphQueryBuilderServiceTest {
    ...
    public void getPaymentsCountQueryByTokenRootWithMinimalDataTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_TOKEN_ROOT_WITH_MINIMAL_DATA, query);
    }
    ...
    public void getPaymentsCountQueryByTokenRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_TOKEN_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByTokenRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_TOKEN_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByEmailRootWithMinimalDataTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_EMAIL_ROOT_WITH_MINIMAL_DATA, query);
    }
    ...
    public void getPaymentsCountQueryByEmailRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_EMAIL_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByEmailRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_EMAIL_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByFingerprintRootWithMinimalDataTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_FINGERPRINT_ROOT_WITH_MINIMAL_DATA, query);
    }
    ...
    public void getPaymentsCountQueryByFingerprintRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_FINGERPRINT_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByFingerprintRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_FINGERPRINT_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByIpRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_IP_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByIpRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_IP_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByIpRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_IP_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCurrencyRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_CURRENCY_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCurrencyRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_CURRENCY_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCurrencyRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_CURRENCY_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByShopIdRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_SHOP_ID_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByShopIdRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_SHOP_ID_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByShopIdRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_SHOP_ID_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByPartyIdRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_PARTY_ID_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByPartyIdRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_PARTY_ID_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByPartyIdRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_PARTY_ID_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCountryBankRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_COUNTRY_BANK_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCountryBankRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_COUNTRY_BANK_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCountryBankRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_COUNTRY_BANK_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCountryIpRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_COUNTRY_IP_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCountryIpRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_COUNTRY_IP_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByCountryIpRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_COUNTRY_IP_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByMobileRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_MOBILE_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByMobileRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_MOBILE_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByMobileRootWithFullDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_MOBILE_ROOT_WITH_FULL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByRecurrentRootWithMinimalDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_RECURRENT_ROOT_WITH_MINIMAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByRecurrentRootWithUsualDatasetTest() {
        ...
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_RECURRENT_ROOT_WITH_USUAL_DATASET, query);
    }
    ...
    public void getPaymentsCountQueryByRecurrentRootWithFullDatasetTest() {
        ...
        String query = getPaymentsCountQuery(DgraphEntity.PAYMENT, dgraphMap);
        assertNotNull(query);
        assertEquals(DgraphPaymentCountQueryBuilderServiceTestData.BY_RECURRENT_ROOT_WITH_FULL_DATASET, query);
    }
